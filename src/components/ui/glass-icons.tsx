      ...
      {items.map((item, index) => {
        const ButtonContent = (
          <>
            ...
            >
              <span
                className="m-auto w-[1.5em] h-[1.5em] flex items-center justify-center text-white text-2xl"
                aria-hidden="true"
              >
                {item.icon}
              </span>
        ...
        const baseClassName = `relative bg-transparent outline-none w-[4.5em] h-[4.5em] [perspective:24em] [transform-style:preserve-3d] [-webkit-tap-highlight-color:transparent] group ${
          item.customClass || ""
        }`;
