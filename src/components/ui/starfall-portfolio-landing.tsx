        ...
        <main id="about" className="w-full h-screen flex flex-col items-center justify-center px-6">
            <div className="max-w-6xl mx-auto text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
                    {ctaButtons.primary && <div>{ctaButtons.primary.label}</div>}
                    {ctaButtons.secondary && <button onClick={ctaButtons.secondary.onClick} className="bg-card/30 backdrop-blur-md border border-border hover:bg-card/50 transition-all min-w-[160px] text-sm font-medium text-foreground rounded-lg px-6 py-3">{ctaButtons.secondary.label}</button>}
                </div>
                ...
                <div id="projects" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto mb-16">
                    {projects.map((project, index) => <div key={index} className="bg-card/30 backdrop-blur-md border border-border hover:bg-card/40 transition-all rounded-2xl p-6 text-left">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {project.tags.map(tag => <span key={tag} className="bg-secondary/50 border border-border px-2 py-1 rounded text-xs text-muted-foreground">{tag}</span>)}
                            </div>
                        </div>)}
                </div>
