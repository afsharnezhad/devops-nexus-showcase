...
const PreLanding = () => {
  ...
  const portfolioData = {
    logo: {
      initials: <div className="w-24 h-24 rounded-full border-2 border-primary/30 bg-background/50 backdrop-blur-sm flex items-center justify-center p-3 shadow-lg">
          <img src={autoopsLogo} alt="AutoOps Logo" className="w-full h-full object-contain" />
        </div>,
      name: ''
    },
    navLinks: [],
    darkModeToggle: <button onClick={toggleDarkMode} className="fixed top-6 right-6 z-50 w-12 h-12 bg-card/30 backdrop-blur-md border border-border hover:bg-card/50 transition-all rounded-full flex items-center justify-center group" aria-label="Toggle dark mode">
    ...
    hero: {
      titleLine1: <div className="flex items-center justify-between gap-8 max-w-6xl mx-auto px-8">
          ...
          <div className="flex-1 text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-3xl md:text-4xl font-bold mb-3">Mohammad Sadegh Afsharnezhad </p>
            ...
            <div className="text-center font-vazirmatn" dir="rtl">
              ...
              <p className="text-3xl md:text-4xl font-bold mb-3">محمدصادق افشارنژاد </p>
              <p className="text-xl md:text-2xl bg-gradient-to-r from-primary via-purple-500 to-primary bg-clip-text text-transparent mb-4">
          ...
          <div className="flex flex-col items-center">
            <div className="w-56 h-72 rounded-2xl overflow-hidden border-4 border-primary/20 shadow-lg hover:scale-105 transition-transform duration-300">
              <img src="/professional-photo.png" alt="Mohammad Sadegh Afsharnezhad Mehrabi" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>,
      titleLine2Gradient: '',
    ...
    ctaButtons: {
      primary: {
        label: <GradientButton onClick={() => navigate('/home')} className="text-lg font-semibold">
